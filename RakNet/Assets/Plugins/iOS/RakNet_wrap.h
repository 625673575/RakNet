...
public:
    ...
    virtual bool OnFile(RakNet::FileListTransferCBInterface::OnFileStruct *onFileStruct);
    virtual void OnFileProgress(RakNet::FileListTransferCBInterface::FileProgressStruct *fps);
    virtual bool Update();
    virtual bool OnDownloadComplete(RakNet::FileListTransferCBInterface::DownloadCompleteStruct *dcs);
